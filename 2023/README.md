# A Flock of Swifts - 2023

## 2023.12.30

Monty showed the functionality and some code for his calendar app.

Mark asked about using a semaphore to stop reentrancy in actor functions at suspension points.   Rainer offered an AsyncSequence as an alternative to serialize work.

We reviewed setting up and using OSLog and log levels.

Josh continued with his VisionOS example.
```swift
@main
...
public struct PlayerSystem: System {
    ...
    public mutating func update(context: SceneUpdateContext) {
        ...
        cannon.transform = .init(AffineTransform3D
